...
public class FrmLinkedList extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnOrdenar.setText("Ordenar (HeapSort)");
   ...
   // Ordenar la lista según el tipo seleccionado
    switch(cbTipoLista.getSelectedIndex()) {
        case 0:
                if (lista.isEmpty()) { //Verifica si la lista está vacía antes de ordenar
                    JOptionPane.showMessageDialog(this,"La lista está vacía, no se puede ordenar.", 
                        "WARNING",JOptionPane.WARNING_MESSAGE);
                    return;
                }           
            // Ordenar la lista enlazada simple usando HeapSort
            lista.HeapSort();            
            JOptionPane.showMessageDialog(this,"La lista simple ha sido ordenada con éxito.", 
                "WARNING",JOptionPane.INFORMATION_MESSAGE);
            break;
        case 1:
                if (doubleLinkedList.isEmpty()) { //Verifica si la lista está vacía antes de ordenar
                    JOptionPane.showMessageDialog(this,"La lista está vacía, no se puede ordenar.", 
                        "WARNING",JOptionPane.WARNING_MESSAGE);
                    return;
                }            
            // Ordenar la lista doblemente enlazada usando HeapSort
            doubleLinkedList.HeapSort();
            JOptionPane.showMessageDialog(this,"La lista ha sido ordenada con éxito.", 
                "MENSAJE",JOptionPane.INFORMATION_MESSAGE);
            break;
        default:
            JOptionPane.showMessageDialog(this,"Tipo de lista no soportado para ordenamiento.", 
